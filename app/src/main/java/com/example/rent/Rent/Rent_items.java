...
public class Rent_items {

    private String date_from, date_to, user_name, user_firstname, logement_name, price;

    public Rent_items(String date_from, String date_to, String user_name, String user_firstname, String logement_name, String price){
    ...
    public static void add(Rent_items comment_items) {
    }
