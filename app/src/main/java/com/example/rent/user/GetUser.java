...
public class GetUser extends AsyncTask<String,String,String> {
    ...
    public GetUser(UserActivity aa, int userId){
        this.act = aa;
        this.userId = userId;
    }
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            url = new URL(this.act.getResources().getString(R.string.url) + "/getuser.php?id=" + userId);
    ...
    protected void onPostExecute(String s) {
        this.act.onTaskCompleteGetUser(s);
    }
}