...
public class AddHomeConfActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_home_conf);
        ...
        this.accueil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent home = new Intent(AddHomeConfActivity.this, homepageActivity.class);
                startActivity(home);
            }
        });
    }
